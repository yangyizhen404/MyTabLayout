...
//        int bottomLineMode = a.getInt(R.styleable.TabLayout_bottomLineMode, 0);
//        if (bottomLineMode == 1) {
            int bottomLineColor = a.getColor(R.styleable.TabLayout_bottomLineColor, getResources().getColor(R.color.darker_gray));
            int bottomLineHeight = a.getDimensionPixelSize(R.styleable.TabLayout_bottomLineHeight, 0);
//            LinearLayout linearLayout = new LinearLayout(context);
//            linearLayout.setOrientation(LinearLayout.VERTICAL);
//            LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, 0);
//            layoutParams.weight = 1;
//            layoutParams.gravity = Gravity.CENTER;
//            linearLayout.addView(mTabStrip, layoutParams);
//            View view = new View(context);
//            view.setBackgroundColor(bottomLineColor);
//            linearLayout.addView(view, new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, bottomLineHeight));
//            super.addView(linearLayout, 0, new LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.MATCH_PARENT));
//        } else {
//            LayoutParams layoutParams = new LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.MATCH_PARENT);
//            if (bottomLineMode == 2) {
//                mTabStrip.setBottomLineHeight(a.getDimensionPixelSize(R.styleable.TabLayout_bottomLineHeight, 0));
//                mTabStrip.setBottomLineColor(a.getColor(R.styleable.TabLayout_bottomLineColor, getResources().getColor(R.color.darker_gray)));
//            }
//            super.addView(mTabStrip, 0, layoutParams);
//        }
        mTabStrip.setBottomLineColor(bottomLineColor);
        mTabStrip.setBottomLineHeight(bottomLineHeight);
        mTabStrip.setDividerColor(a.getColor(R.styleable.TabLayout_dividerColor,getResources().getColor(R.color.darker_gray)));
        mTabStrip.setDividerHeight(a.getDimensionPixelSize(R.styleable.TabLayout_dividerHeight,0));
        mTabStrip.setDividerWidth(a.getDimensionPixelSize(R.styleable.TabLayout_dividerWidth,0));
        mTabStrip.setmSelectedIndicatorWidth(a.getDimensionPixelSize(R.styleable.TabLayout_tabIndicatorWidth, 0));
    ...
    private class SlidingTabStrip extends LinearLayout {
        ...
        private final Paint mBottomLinerPaint;
        ...
        void setDividerColor(int color) {
            if (mDividerPaint.getColor() != color) {
                mDividerPaint.setColor(color);
                ViewCompat.postInvalidateOnAnimation(this);
            }
        }
        void setDividerWidth(int width) {
            if (dividerWidth != width) {
                dividerWidth = width;
                ViewCompat.postInvalidateOnAnimation(this);
            }
        }
        ...
        void setBottomLineColor(int color) {
            if (mBottomLinerPaint.getColor() != color) {
                mBottomLinerPaint.setColor(color);
                ViewCompat.postInvalidateOnAnimation(this);
            }
        }
        void setBottomLineHeight(int height) {
            if (bottomLineHeight != height) {
        ...
        public void draw(Canvas canvas) {
            ...
            if (mSelectedIndicatorPaint != null && mIndicatorLeft >= 0 && mSelectedIndicatorHeight > 0 && mIndicatorRight > mIndicatorLeft && mSelectedIndicatorWidth != 0) {
                int offset = 0;
                ...
                RectF rectF = new RectF(mIndicatorLeft + offset, getHeight() - mSelectedIndicatorHeight - bottomLineHeight, mIndicatorRight - offset, getHeight() - bottomLineHeight);
//                canvas.drawRect(mIndicatorLeft, getHeight() - mSelectedIndicatorHeight,
//                        mIndicatorRight, getHeight(), mSelectedIndicatorPaint);
                canvas.drawRoundRect(rectF, 2, 1, mSelectedIndicatorPaint);
            }
            if (mBottomLinerPaint != null && bottomLineHeight > 0) {
                RectF rectF = new RectF(getPaddingLeft(), getHeight() - bottomLineHeight, getWidth() - getPaddingRight(), getHeight());
                canvas.drawRoundRect(rectF,2,1,mBottomLinerPaint);
            }
            if (dividerWidth>0&&dividerHeight!=0&&getChildCount()>1){
                int childCount = getChildCount();
                for (int i = 0 ; i<childCount -1;i++){
                    int dividerVoffset = (getHeight()-dividerHeight)/2;
                    if (dividerVoffset<0||dividerHeight<0){
                        dividerVoffset=0;
                    }
                    int dividerHoffset = dividerWidth/2;
                    RectF rectF = new RectF(getChildAt(i).getRight()-dividerHoffset,dividerVoffset,getChildAt(i).getRight()+dividerHoffset,getHeight()-dividerVoffset);
                    canvas.drawRoundRect(rectF,1,2,mDividerPaint);
                }
            }
